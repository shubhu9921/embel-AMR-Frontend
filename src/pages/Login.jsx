...
export default function LoginPage({ onLogin }) {
    ...
    return (
        <div className="min-h-screen w-full flex bg-gray-50">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-[#002D5E] relative overflow-hidden items-center justify-center p-12 text-white">
                <div className="absolute inset-0 bg-gradient-to-br from-[#002D5E] to-[#112240] backdrop-blur-3xl"></div>
                <div className="relative z-10 max-w-xl">
                    <div className="mb-8">
                        <div className="bg-white rounded-2xl flex items-center justify-center shadow-lg shadow-blue-900/20 mb-6 p-4 w-fit">
                            <img
                        ...
                        <h1 className="text-5xl font-bold mb-6 leading-tight">Smart Energy Management</h1>
                        <p className="text-blue-100 text-lg leading-relaxed">
                            Monitor, analyze, and optimize your energy consumption with our advanced AMR solution.
                ...
                {/* Abstract shapes */}
                <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#ff6e00]/20 rounded-full blur-3xl"></div>
                ...
                <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 sm:p-12 border border-gray-100">
                    <div className="text-center mb-10">
                        <img
                            src="https://www.embel.co.in/images/logos/logo-embel.png"
                            alt="Embel Logo"
                            className="h-10 mx-auto mb-6 object-contain lg:hidden"
                        />

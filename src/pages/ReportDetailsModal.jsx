            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-slate-800">{report.name}</h2>
                ...
                <div className="p-6 overflow-y-auto max-h-[60vh]">
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-slate-500">Generated on {report.generated}</span>
                        </div>

                        {/* Report Details */}
                        <div className="bg-slate-50 rounded-xl p-4">
                            <h3 className="text-sm font-semibold text-slate-700 mb-3">Report Details</h3>
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    <p className="text-slate-500">Report ID</p>
                                    <p className="font-medium text-slate-800">RPT-{report.id.toString().padStart(3, '0')}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <p className="text-slate-500">Meter Type</p>
                                    <p className="font-medium text-slate-800">{report.meter}</p>
                                </div>
                                <div>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <p className="font-medium text-slate-800">
                                        Comprehensive analysis of {report.meter.toLowerCase()} metrics for the period of {report.period}.
                                    </p>
                                </div>
                            </div>
                        </div>

                        {/* Statistics / "Billing Details" equivalent */}
                        <div className="bg-slate-50 rounded-xl p-4">
                            <h3 className="text-sm font-semibold text-slate-700 mb-3">Statistics Summary</h3>
                            <div className="space-y-3">
                                <div className="flex justify-between text-sm">
                                    <span className="text-slate-500">Total Records</span>
                                    <span className="font-medium text-slate-800">1,245</span>
                                </div>
                                <div className="flex justify-between text-sm">
                                    <span className="text-slate-500">Data Points</span>
                                    <span className="font-medium text-slate-800">45,000</span>
                                </div>
                                <div className="flex justify-between text-sm">
                                ...
                                <div className="flex justify-between text-sm pt-3 border-t border-slate-200">
                                    <span className="font-semibold text-slate-800">Data Quality Score</span>
                        ...
                        <div className="flex items-center gap-3 text-sm">
                            ...
                            <span className="font-semibold text-slate-800">2026-01-15</span>
                        </div>
                    </div>
                </div>

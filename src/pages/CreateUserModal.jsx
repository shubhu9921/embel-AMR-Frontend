...
export default function CreateUserModal({ isOpen, onClose, onSubmit }) {
    ...
    const handleChange = (e) => {
        const { name, value } = e.target; // Fixed: Use name instead of id if possible, but the inputs in HTML didn't have names. I will add them.
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white w-[450px] rounded-2xl shadow-2xl p-6 border border-slate-100 animate-in fade-in zoom-in-95 duration-200 relative z-10">

                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-black text-slate-800 tracking-tight">Create New Account</h2>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-50 border-none rounded-xl px-4 py-2.5 text-sm font-bold focus:ring-2 focus:ring-blue-500 transition-all outline-none"
                        ...
                        <div className="col-span-2 space-y-1">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    value={formData.role}
                                    onChange={handleChange}
                                    className="w-full bg-slate-50 border-none rounded-xl px-4 py-2.5 text-sm font-bold focus:ring-2 focus:ring-blue-500 transition-all outline-none appearance-none disabled:opacity-70"
                                    required
                                >
